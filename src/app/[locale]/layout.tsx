...
import { CipherField } from "@/components/site/cipher-field";
    ...
    >
      <body className="relative min-h-svh">
        ...
        >
          ...
          <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,black,transparent_88%)] opacity-60">
            <CipherField />
          </div>
        </div>
